...
<html lang="en">
	...
	<head>
		...
		<!--end::Layout Skins -->
		<link rel="shortcut icon" href="assets/media/logo/logo3.png" />
		...
		<div class="kt-grid kt-grid--hor kt-grid--root">
			<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--ver kt-page">
				<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
					...
					<!-- begin:: Footer -->
					<div class="hilang kt-footer  kt-grid__item kt-grid kt-grid--desktop kt-grid--ver-desktop" id="kt_footer">
						<div class="kt-container  kt-container--fluid ">
							<div class="kt-footer__copyright">
								2019&nbsp;&copy;&nbsp;<a href="http://keenthemes.com/metronic" target="_blank" class="kt-link">Fachreza Maulana</a>
							</div>
							<div class="kt-footer__menu">
								<a href="https://fachreza-maulana.com" target="_blank" class="kt-footer__menu-link kt-link">About</a>
								<a href="https://fachreza-maulana.com" target="_blank" class="kt-footer__menu-link kt-link">Team</a>
								<a href="https://fachreza-maulana.com" target="_blank" class="kt-footer__menu-link kt-link">Contact</a>
							</div>
						</div>
					</div>
