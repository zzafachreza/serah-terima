...
$sql = $conn->prepare("SELECT id FROM master_solusi"); // Query untuk menghitung seluruh data siswa

$sql->execute();



$query = "SELECT * FROM master_solusi WHERE (id LIKE '%".$search."%' OR hasil LIKE '%".$search."%' OR ciri LIKE '%".$search."%' OR solusi LIKE '%".$search."%')";
