...
$sql = $conn->prepare("SELECT id FROM saran"); // Query untuk menghitung seluruh data siswa

$sql->execute();



$query = "SELECT * FROM saran WHERE (id LIKE '%".$search."%' OR nama LIKE '%".$search."%' OR email LIKE '%".$search."%' OR tgl LIKE '%".$search."%' OR pesan LIKE '%".$search."%' OR subjek LIKE '%".$search."%')";
