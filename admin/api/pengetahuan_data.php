...
$sql = $conn->prepare("SELECT id FROM master_pengetahuan"); // Query untuk menghitung seluruh data siswa

$sql->execute();



$query = "SELECT * FROM master_pengetahuan WHERE (id LIKE '%".$search."%' OR pertanyaan LIKE '%".$search."%' OR id_gangguan LIKE '%".$search."%' OR id_solusi LIKE '%".$search."%')";
