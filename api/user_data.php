...
$sql = $conn->prepare("SELECT username FROM master_user"); // Query untuk menghitung seluruh data siswa
$sql->execute();

$query = "SELECT * FROM master_user WHERE (username LIKE '%".$search."%' OR nama_lengkap LIKE '%".$search."%' OR telepon LIKE '%".$search."%' OR alamat LIKE '%".$search."%')";
