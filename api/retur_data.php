...
$sql = $conn->prepare("SELECT id FROM retur"); // Query untuk menghitung seluruh data siswa

$sql->execute();



$query = "SELECT * FROM retur WHERE (nama_supplier LIKE '%".$search."%' OR no_retur LIKE '%".$search."%' OR nama_barang LIKE '%".$search."%')";
