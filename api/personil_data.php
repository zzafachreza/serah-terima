...
$sql = $conn->prepare("SELECT id FROM personil"); // Query untuk menghitung seluruh data siswa
$sql->execute();

$query = "SELECT * FROM personil WHERE (nama LIKE '%".$search."%' OR nip LIKE '%".$search."%' OR pangkat LIKE '%".$search."%' OR jabatan LIKE '%".$search."%')";
