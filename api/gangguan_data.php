...
$sql = $conn->prepare("SELECT id FROM master_gangguan"); // Query untuk menghitung seluruh data siswa

$sql->execute();



$query = "SELECT * FROM master_gangguan WHERE (id LIKE '%".$search."%' OR gangguan LIKE '%".$search."%')";
