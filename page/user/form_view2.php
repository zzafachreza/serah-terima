											...
											<form class="kt-form kt-form--label-right" id="formUserEdit" enctype="multipart/form-data">
													...
													<div class="col col-sm-5">
														...
														<div class="form-group">
															...
															<span class="form-text text-muted">Silhakan masukan Nama Lengkap / Nama Supplier </span>
														</div>
														<div class="form-group">
														...
														<div class="form-group">
															...
															<select name="level" class="form-control selectza" data-live-search="true">
															  ...
															  <option data-tokens="Receiving" <?php echo $data['level']=='Receiving'?'selected':'' ?>>Receiving</option>
															   <option data-tokens="Supplier" <?php echo $data['level']=='Supplier'?'selected':'' ?>>Supplier	</option>
															</select>
														</div>
													</div>
													<div class="col col-sm-5">
